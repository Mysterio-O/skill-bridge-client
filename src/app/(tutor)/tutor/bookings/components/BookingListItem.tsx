                ...
                <div className="min-w-0">
                    ...
                    <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-1 text-sm">
                        <p className="text-muted-foreground">
                            Start:{" "}
                            <span className="text-foreground">{formatDT(booking.startAt)}</span>
                        </p>
                        <p className="text-muted-foreground">
                            End:{" "}
                            <span className="text-foreground">{formatDT(booking.endAt)}</span>
                        </p>
                        <p className="text-muted-foreground">
                            Duration:{" "}
                            <span className="text-foreground">{booking.durationMinutes} min</span>
                        </p>
                        <p className="text-muted-foreground">
                            Total:{" "}
